...
public class MassageController {
    ...
    @PostMapping("/massage/id")
    public MassageModel getDataMassageByID4Number(@RequestBody SearchDTO searchDTO) {
        return massageService.getDataMassageByID4Number(searchDTO);
    }

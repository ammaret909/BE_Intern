...
public class ReceiveLoginController {
    ...
    @GetMapping("dashboard/login_logout/{rccUser}")
    public List<LoginAndLogoutSelectByIdDTOout> dashboardLoginAndLogoutByUser(@PathVariable String rccUser) {
        return receiveLoginService.dashboardLoginAndLogoutByUser(rccUser);
    }
}
